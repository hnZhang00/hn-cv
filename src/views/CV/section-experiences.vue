<template>
  <section class="cv-section hobbies">
    ...
    <div v-for="item in list" class="cv-section-item">
      ...
      <ul class="list">
        <li class="list-item">
          <span class="item-title">工作职位:&nbsp;</span>
          {{ item.job }}
        </li>
        <li class="list-item">
      ...
      list: [
        {
          ...
          time: '2016.07 至今',
          job: '前端开发工程师',
          responsibilities: '公司产品“流程大师”的迭代任务、项目部的前端支持',
          // responsibilities: '公司产品“流程大师”的迭代任务；项目部的前端支持；部分项目的前端负责人，负责其前端技术架构选型，把控开发进度',
        }
      ]
    }
  }
